...
<div class="Notice">
		...
		<div class="not-warp" id="scroll_div">
			<div id="" class="not-warp-in">
				<div class="fsize12 f-fM p-txt" id="scroll_begin">
					...
					<tt class="fsize14 f-fM vam">欢迎老板进入。</tt>
				</div>
		...
		<div>
			...
			<div id="header">
				...
				<div id="top">
					<!-- Logo -->
					<div class="logo">
						<a href="https://blog.csdn.net/qq_17589751" target="_blank" title="在线教育软件 " class="tooltip">
							<img src="${ctx}/static/admin/assets/logo.png" height="60" alt="在线教育软件" />
						</a>
					</div>
					<!-- End of Logo -->
	...
	<div id="footer">
		...
		<p class="mid">
			Powered By <a target="_blank" href="https://blog.csdn.net/qq_17589751" style="color: #666;">${websitemap.web.company}</a>
		</p>
	</div>
		<script type="text/javascript">
			$(function () {
